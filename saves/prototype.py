...
def palavras_chaves_usuario():
    ...
    user_smalltalk_generic = ["","","","","","","","","","","","","","",]
    user_end = ["sair","tchau","flw","flww","até mais","ate mais","Sair", "Tchau", "Flw", "Flww", "Até mais", "Ate mais", 
           "ate", "até", "adeus", "bye", "bye bye", "falou", "falou falou", "falou falou!", "exit", "end", "vazar", "vaza"]
    return  user_response_greetings, user_smalltalk_generic, user_end
...
def chatbot(): #isso traz as lista de palavras e frases das funçoes 
    user_response_greetings, user_smalltalk_generic, user_end = palavras_chaves_usuario()
    ...
    while True: # Loop principal do chat
        ...
        elif any(keyword in user_input for keyword in user_smalltalk_generic):
